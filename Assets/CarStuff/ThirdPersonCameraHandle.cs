...
public class ThirdPersonCameraHandle : MonoBehaviour 
{
	...
	void Update () 
    {
        ...
        //modify that angle
        rotationAngle *= Mathf.Clamp(GameControl.horizontalAxisHeldFor / .5f, 0, 10) * carController.speedInMph/carController.maxSpeed; //angle the camera into the turn more based on how long the left stick is held
